...
const Bcsittimetable = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 bg-gray-100 min-h-screen">
      <div className="bg-white p-6 rounded-lg shadow-lg">
        ...
        <div className="space-y-6">
          {questions.length === 0 ? (
            <p className="text-gray-500 text-center">No Time Table PDFs or images available.</p>
          ) : (
      ...
      {selectedQuestion && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 p-4">
          <div className="bg-white p-6 rounded-lg shadow-lg max-w-2xl w-full relative">
            ...
            <h2 className="text-2xl font-bold mb-4 text-blue-700">📌 Course Details</h2>
