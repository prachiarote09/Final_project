    ...
    <div className="max-w-6xl mx-auto p-4 sm:p-6 bg-gray-100 min-h-screen">
        ...
        <div className="space-y-4 sm:space-y-6">
          {questions.length === 0 ? (
            <p className="text-gray-500 text-center">
              No Question Bank PDFs or images available.
            </p>
          ) : (
                  ...
                  {question.pdf && (
                    <>
                      <button
                        ...
                        className="bg-blue-500 text-white px-4 py-2 rounded flex items-center gap-2 hover:bg-blue-600 w-full sm:w-auto justify-center"
                      >
                        <FaEye />
                        View PDF
                      </button>
                      <button
                        ...
                        className="bg-green-500 text-white px-4 py-2 rounded flex items-center gap-2 hover:bg-green-600 w-full sm:w-auto justify-center"
                      >
                        <FaDownload />
                        Download PDF
                      </button>
      ...
      {selectedQuestion && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 p-4 sm:p-6">
          <div className="bg-white p-4 sm:p-6 rounded-lg shadow-lg max-w-md sm:max-w-lg w-full relative">
            <button
              onClick={closeModal}
            ...
            <h2 className="text-xl sm:text-2xl font-bold mb-4 text-blue-700">📌 Course Details</h2>
