...
const Bcsitresult = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 bg-gray-100 min-h-screen">
        ...
        <div className="space-y-6">
          {questions.length === 0 ? (
            ...
            questions.map((question) => (
              <div
                key={question.id}
                className="p-4 border rounded-lg bg-gray-50 shadow-md transition transform hover:shadow-lg hover:scale-105"
              >
