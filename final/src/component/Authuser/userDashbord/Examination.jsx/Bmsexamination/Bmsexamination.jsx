  ...
  return (
    <div className="font-sans min-h-screen bg-gradient-to-b from-gray-50 to-gray-200 p-6">
      <h1 className="text-3xl font-bold text-center mt-6 text-blue-700">
        BMS Examination - Student Portal
      </h1>
      <div className="flex justify-center gap-8 mt-8 flex-wrap">
        <Section title="Exam Timetable" path="/user-dashboard/examinations/bms/exam-timetable" />
        <Section title="Course Overview" path="/user-dashboard/examinations/bms/course-overview" />
        <Section title="Previous Year Question Paper" path="/user-dashboard/examinations/bms/previous-paper" />
        <Section title="Question Bank" path="/user-dashboard/examinations/bms/question-bank" />
        <Section title="Result" path="/user-dashboard/examinations/bms/percentage" />
      </div>
    </div>
  );
}
