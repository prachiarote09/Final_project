...
const BmsCourse = () => {
  ...
  return (
    <div className="max-w-full mx-auto p-4 md:p-6 bg-gray-100 min-h-screen">
      ...
      {selectedQuestion && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 px-4">
          <div className="bg-white p-4 md:p-6 rounded-lg shadow-lg max-w-lg w-full relative">
            <button
              onClick={closeModal}
            ...
            {selectedQuestion.pdf && (
              <iframe
                ...
                className="w-full h-56 md:h-64 border rounded-lg"
                title="PDF Viewer"
              />
            )}
